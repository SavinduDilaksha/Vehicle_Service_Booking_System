...
export default function Home() {
  ...
  useEffect(() => {
    ...
    Promise.all(requests)
      .then(([sRes, aRes, bRes]) => {
        ...
        if (bRes) setUserBookings(bRes.data);
      })
  ...
  return (
    <div>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: 640 }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <Link to="/book" className="btn-primary" style={{ fontSize: '0.95rem', padding: '0.9rem 2.5rem' }}>
                Book Appointment <ArrowRight size={18} />
              </Link>
              <Link to="/services" className="btn-white" style={{ fontSize: '0.95rem', padding: '0.9rem 2rem' }}>
                Our Services
              </Link>
            </div>
      ...
      <section id="services" className="section" style={{ background: 'var(--grey-50)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '1.5rem' }}>
            {categories.map((cat) => (
              <div key={cat._id} className="card" style={{ cursor: 'pointer' }}>
                ...
                <div style={{ padding: '1.5rem' }}>
                  ...
                  <Link to={`/services/${cat.slug}`} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.85rem', fontWeight: 700, color: 'var(--navy)', textDecoration: 'none' }}>
      ...
      <section className="section" style={{ background: 'var(--navy)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
            {steps.map((step) => (
              <div key={step.num} style={{ textAlign: 'center', padding: '2rem 1rem' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
            <Link to="/book" className="btn-primary" style={{ fontSize: '1rem', padding: '1rem 3rem' }}>
        ...
        <section className="section" style={{ background: 'var(--grey-50)' }}>
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '1.5rem' }}>
              {announcements.map((a) => (
                <div key={a._id} style={{ background: 'white', borderRadius: 12, padding: '1.75rem', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--grey-100)', borderTop: '4px solid var(--amber)' }}>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <Link to="/book" className="btn-primary">Schedule a Visit <ArrowRight size={16} /></Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ============================================================
          CONTACT SECTION WITH LIVE GOOGLE MAPS EMBED
      ============================================================ */}
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '3rem' }}>
            ...
            <div>
              ...
              <div style={{ borderRadius: 12, overflow: 'hidden', height: 220, background: 'var(--grey-200)', boxShadow: 'var(--shadow-sm)' }}>
                <iframe
            ...
            <div className="card" style={{ padding: '2.5rem' }}>
              <h3 style={{ fontSize: '1.25rem', color: 'var(--navy)', marginBottom: '1.25rem' }}>Send Us A Message</h3>
              
              {contactSubmitted ? (
                <div style={{ background: '#D1FAE5', color: '#065F46', padding: '1.5rem', borderRadius: 10, textAlign: 'center' }}>
                  <CheckCircle size={32} style={{ marginBottom: '0.5rem' }} />
                  <div style={{ fontWeight: 700 }}>Thank you for reaching out!</div>
                  <div style={{ fontSize: '0.85rem', marginTop: 4 }}>We have received your message and will respond shortly.</div>
                </div>
              ) : (
                <form onSubmit={(e) => { e.preventDefault(); setContactSubmitted(true); }} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    <div>
                      ...
                      <input type="tel" className="form-input" placeholder="07X XXX XXXX" />
                    </div>
                    <div>
                      <label className="form-label">Subject *</label>
                      <input required className="form-input" placeholder="How can we help?" />
                    </div>
                  </div>
                  <div>
                    <label className="form-label">Message *</label>
                    <textarea required rows={5} className="form-input" placeholder="Tell us more about your inquiry..." style={{ resize: 'vertical' }} />
                  </div>
